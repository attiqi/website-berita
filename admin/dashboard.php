     ...
     ?>
      <nav class="navbar navbar-expand-lg" style="background-color: #C8DBBE;">
        <div class="container-fluid">
          ...
          <a class="navbar-brand m-2" href="#">Admin Panel</a><a href="logout.php" class="btn" style=" border-color: #C8DBBE; color: black;">Logout</a>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      ...
                      <center>
            <a href="print.php? id=<?php $show['id'] ?>" target="_blank" class="btn btn-sm btn-primary">
                      Cetak PDF
                    </a>
            </center>
                    </div>
