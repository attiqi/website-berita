                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input"><input type="number" name="id" id="id" value="<?php echo $show['id']; ?>"></div>
                      </div>
                      <div class="form-group">
                        <label for="nama">Judul</label>
                        <div class="input">
                          <input type="text" name="nama" id="nama" value="<?php echo $show['nama']; ?>"></div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input">
                          <select id="kategori_id" name="kategori_id" >
                            <option value="<?php echo $show['kategori_id']; ?>">--Pilih Kategori--</option>
                            <?php 
       ...
       <?php
        include "../connect.php";
          if (isset($_POST['proses'])) {
            ...
            mysqli_query($koneksi_server,"update konten set 
            nama = '$_POST[nama]',
            isi = '$_POST[isi]',
