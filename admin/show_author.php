  ...
  <body>
    ...
    ?>
        <?php
          include "../connect.php";
          $id = $_GET['id'];
          $ambildata = mysqli_query($koneksi_server, "select * from konten where id='$id'");
                  ...
                  <div class="card-body">
                    <form method="post" action="" enctype="multipart/form-data"> 
                      <div class="form-group">
                        ...
                        <div class="input"><input type="text" name="id" id="id" value="<?php echo $show['id']; ?>"></div>
                      </div>
                      <div class="form-group">
                        <label for="nama">Judul</label>
                        <div class="input"><input type="text" name="nama" id="nama" value="<?php echo $show['nama']; ?>"></div>
                      </div>
                      <div class="form-group">
                        <label for="nama">Isi Konten</label>
                        <div class="input"><input type="text" name="isi" id="isi" value="<?php echo $show['isi']; ?>"></div>
                      </div>
                      <div class="form-group">
                        <label for="kategori_id">Kategori</label>
                        <div class="input">
                        <input type="text" name="kategori" id="kategori" value="<?php echo $show['kategori_id']; ?>">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input"><input type="file" id="file" name="file" value= "<?php echo $show['file']; ?>"></div>
                      </div><br>
                      <div class="form-group">
