            ...
            <div class="row">
              <div class="col-12 col-xl-12 mb-4 mb-lg-0">
                <div class="card">
                  ...
                  <div class="card-body">
                    <a href="tambah_kategori.php" class="btn btn-sm btn-primary" style="background: #9F8772; border-color: #9F8772;"> Tambah Kategori Details</a>
                          ...
                          <?php
                            ...
                            echo'
                              <tr>
                                ...
                                <td>'.$data['jenis'].'</td>
                                  <td>
                                    <a href="show_kategori.php? id='.$data['id'].'" class="btn btn-sm btn-primary"style="background: #9F8772; border-color: #9F8772;">Lihat</a> 
                                    
                                    <a href="edit_kategori.php? id='.$data['id'].'" class="btn btn-sm btn-primary"style="background: #9F8772; border-color: #9F8772;">Edit</a> 
                                    
                                    <a href="del_kategori.php? id='.$data['id'].'" class="btn btn-sm btn-primary"style="background: #9F8772; border-color: #9F8772;">Hapus</a> 
