            ...
            <div class="row">
              <div class="col-12 col-xl-12 mb-4 mb-lg-0">
                <div class="card">
                  ...
                  <div class="card-body">
                    <a href="tambah_artikel.php" class="btn btn-sm btn-primary" style="background: #9F8772; border-color: #9F8772;"> Tambah Artikel Details</a>
                    <div class="table-responsive">
                      <table class="table">
                        <thead>
                          <tr>
                            <th scope="col">Id</th>
                            <th scope="col">Konten_Id</th>
                          ...
                          <?php
                            ...
                            echo'
                              <tr>
                                ...
                                <td>'.$data['detail'].'</td>
                                <td>'.$data['tanggal_up'].'</td>
                                <td>'.$data['status'].'</td>
                                <td>'.$data['author'].'</td>
                                  <td>
                                    <a href="show_artikel.php? id='.$data['id'].'" class="btn btn-sm btn-primary"style="background: #9F8772; border-color: #9F8772;">Lihat</a> 
                                    
                                    <a href="edit_artikel.php? id='.$data['id'].'" class="btn btn-sm btn-primary"style="background: #9F8772; border-color: #9F8772;">Edit</a> 
                                    
                                    <a href="del_artikel.php? id='.$data['id'].'" class="btn btn-sm btn-primary"style="background: #9F8772; border-color: #9F8772;">Hapus</a> 
