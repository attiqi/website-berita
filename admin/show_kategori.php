      ...
      <?php
        ...
        ?>
         <?php
          ...
          $id = $_GET['id'];
          $ambildata = mysqli_query($koneksi_server, "select * from kategori where id='$id'");
                  ...
                  <div class="card-body">
                    <form method="post" action=""> 
                      <div class="form-group">
                        <label for="formFileDisabled" class="form-label">ID</label>
                        <input type="text" name="id" class="form-control" id="formFileDisabled" value="<?php echo $show['id']; ?>">
                      </div>
                      <div class="form-group">
                        <label for="formFileDisabled" class="form-label">Kategori</label>
                        <input type="text" name="id" class="form-control" id="formFileDisabled" value="<?php echo $show['jenis']; ?>">
                      </div>
                      </div><br>
                      <div class="form-group">
                        <a href="kategori.php" class="btn btn-sm btn-primary" style="background: #9F8772; border-color: #9F8772;">Kembali</a>
                      </div>
                    </form>
                  </div>
                </div>
