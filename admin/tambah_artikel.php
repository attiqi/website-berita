      ...
      <div class="container-fluid" style="background-color: #9F8772">
        <div class="row">
          ...
          <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
            ...
            <h1 class="h2">Tambah Artikel Detail</h1>
            <p>Selamat Datang, Admin</p>
            <div class="row">
              <div class="col-12 col-xl-12 mb-4 mb-lg-0">
                <div class="card">
                  <h5 class="card-header">Artikel Details</h5>
                  <div class="card-body">
                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>"> 
                      <div class="form-group">
                        <label for="id">id</label>
                        <div class="input"><input type="text" id="id" name="id"></div>
                      </div>
                      <div class="form-group">
                        <label for="konten_id">Konten_Id</label>
                        <div class="input"><input type="text" id="konten_id" name="konten_id"></div>
                      </div>
                      <div class="form-group">
                        <label for="author">Detail Berita</label>
                        <div class="input"><input type="text" id="detail" name="detail"></div>
                      </div>
                      <div class="form-group">
                        <h5 for="date">Tanggal Upload</h5>
                        <input type="date" name="tanggal_up" id="tanggal_up">
                        </input>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input"><input type="text" id="author" name="author"></div>
                      </div><br>
                      <div class="form-group">
       ...
       <?php
        include "../connect.php";
          if (isset($_POST['proses'])) {
            mysqli_query($koneksi_server,"insert into artikel set 
            id          = '$_POST[id]',
