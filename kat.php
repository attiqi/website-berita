      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <?php echo $show['detail']; ?>
              <a href="https://www.cnnindonesia.com/olahraga/20221205205758-170-883198/hasil-drawing-bwf-world-tour-finals-2022-ginting-jonatan-satu-grup">Info Selengkapnya</a>
            </p>
            <h5 class="m-2"><?php echo $show['tanggal_up'];?></h5>
            <center>
            <a href="print.php" target="_blank" class="btn btn-sm btn-primary">
                      Cetak PDF
                    </a>
            </center>
        </div>
