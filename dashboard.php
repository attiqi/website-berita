...
<html lang="en">
  ...
  <body>
    <?php 
      ...
      $sql= "SELECT*FROM konten LEFT JOIN artikel ON konten.id = artikel.konten_id WHERE konten.id";
     ...
     <?php
          ...
          if (isset($_POST['submit_filter'])) {
            if ($_POST['kategori_id'] !== " ") {
              $sql = "SELECT*FROM konten JOIN artikel ON konten.id=artikel.konten_id JOIN kategori konten.kategori_id=kategori.id
              WHERE kategori.id = ".$_POST['kategori_id'] ;
            }
         } 
      ?> 
      <div class="container">
          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="http://localhost/Finalpro/index.html">Login</a>
                </li>
              </ul>
         ...
         foreach ($datas as $data){
          ...
          <div class="col-sm-1">
            <div class="card h-100">
              <img src="admin/upload/'.$data['file'].'" class="card-img-top" alt="...">
              <div class="card-body">
                <h5 class="card-title">'.$data['nama'].'</h5>
                <p class="card-text">
                '.$data['isi'].'
                </p>
                <a href="detail.php? id='.$data['konten_id'].'" class="btn" style="background: #EDE4E0;">Baca Selengkapnya</a>
              </div>
            </div>
          </div>';
        }
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-10 m-2">
            <select class="form-select" aria-label="Default select example" name="kategori_id" id="" style="text-align: center; border-color: #404258; border-radius: 10px; width: 90%">
            <?php 
          ...
          <div class="col-1 m-2">
            <button type="submit" name="submit_filter" style=" border-color: #404258; border-radius: 12px; width: 70%">  <i class="fa fa-search" style="color: #404258;" aria-hidden="true"></i>
            </button>
          </div>
        </div>
          </form>
